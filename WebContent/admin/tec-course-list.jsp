				...
				<table class="table table-border table-bordered table-bg table-hover table-sort">
					...
					<tbody>
						<tr class="text-c">
							...
							<td class="td-manage">
							<a style="text-decoration:none" class="ml-5" onClick="classroom_edit('申请调课','tec-changecourse-add.html','')" href="javascript:;" title="申请调课">申请调课</a>
						</tr>
						<tr class="text-c">
							<td><input name="" type="checkbox" value=""></td>
							...
							<td class="td-status"><span class="label label-success radius">已发布</span></td>
							<td class="td-manage">	
							<!--<a style="text-decoration:none" onClick="picture_stop(this,'10001')" href="javascript:;" title="申请调课"><i class="Hui-iconfont">&#xe6de;</i></a>--> 
							<a style="text-decoration:none" class="ml-5" onClick="changecourse_edit('调课申请','changecourse-add.html','10001')" href="javascript:;" title="申请调课"> <i class="Hui-iconfont">&#xe6df;</i></a> 
						...
						<tr class="text-c">
							...
							<td class="f-14 td-manage">
								...
								<!--<a style="text-decoration:none" class="ml-5" onClick="article_del(this,'10003')" href="javascript:;" title="删除"><i class="Hui-iconfont">&#xe6e2;</i></a>-->
							</td>
						</tr>
						<tr class="text-c">
							<td><input name="" type="checkbox" value=""></td>
